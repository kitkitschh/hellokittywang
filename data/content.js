  ...
  experience: [
    {
      ...
      bullets: [
        "Manage full client lifecycle as account manager, from intake and W9 filing to order confirmations and shipment status updates.",
        "Coordinate international shipping and customs with brokers in Nepal and the US, and manage 2 trucking partners (local NY + nationwide), preparing distribution lists per shipment.",
        "Design custom rug mockups and visual assets for 15+ client presentations as lead designer (Illustrator, Photoshop).",
        "Coordinate production with 3 Nepalese mills, managing logistics for 10-50 orders/month with an ~85% on-time delivery rate.",
        "Manage vendor billing and invoicing via QuickBooks, with monthly revenue reporting averaging $100K/month in Excel.",
        "Founded a Cooper Union internship partnership (as an alumna), launching Summer 2026 to give textile arts students industry experience.",
      ],
    },
    {
      org: "EasyHerb",
      ...
      bullets: [
        "Led social media marketing and content strategy for EasyHerb — 20+ campaigns including brand explainers, memes, and community-building content.",
        ...
        "Navigated Instagram's content policies and cannabis regulations (local + nationwide) to keep all campaigns and Reels compliant while still driving engagement.",
      ],
    },
    {
      org: "Glo Studio Inc",
    ...
    },
    {
      ...
      bullets: [
        "Greeted and served 150+ members and guests daily with personalized, consistent service across club and F&B operations.",
        "Handled 30+ high-volume calls and emails daily, creating reservations and fielding inquiries on menus, hours, and amenities.",
        "Coordinated reservations for groups up to 150 guests across 20+ events, working with F&B managers to ensure covers and tables were ready.",
        "Trained new reception team members on Soho House service standards and phone systems.",
        "Built relationships with members and guests, surfacing feedback to management.",
        "Created spreadsheets of member information to better understand and accommodate member needs.",
      ],
    },
    {
      ...
      bullets: [
        "Pitched, planned, and produced short-form videos for social media, and joined department planning for upcoming exhibitions.",
        "Conducted archival research for documentary-style videos, and assisted with livestreaming, transcription, and asset management.",
